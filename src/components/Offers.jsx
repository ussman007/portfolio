...
import { FaCode, FaMobile, FaDatabase, FaServer, FaPalette, FaTools } from "react-icons/fa";
...
function Offers() {
    const services = [
        ...
        },
        {
            ...
            technologies: ["Node.js", "Express", "php", "REST APIs"]
        },
        {
            id: 4,
            title: "Database Design",
            icon: <FaDatabase className="text-4xl text-purple-400" />,
            description: "Designing and implementing efficient database structures and queries.",
        ...
        },
        {
            ...
            description: "Seamlessly integrating third-party APIs and services into applications.",
            technologies: ["REST APIs", "API Testing"]
        }
    ];
